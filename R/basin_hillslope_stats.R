#' basin_hillslope_stats
#'
#' Using a worldfile, generates stats at the basin and hillslope level, including slope, elevation, and distribution of veg cover types. Returns a list of tables in R, and optionally outputs a text file of tables.
#' @param worldfile Source worldfile
#' @param outfile Output text file containing formatted tables.
#' @param LPC_vegnames TRUE/FALSE Should the veg_parm_IDs of 1,5,3,4 be automatically renamed to tree, shrub, herb, and bare (other).
#' @export
